...
function Footer() {
  return (
    <div className=" flex gap-5 w-fulll h-screen bg-zinc-900">
      <div className='w-1/2 h-full justify-between flex flex-col font-["FounderGrotesk"] p-20'>
        <div className="headings">
          <h1 className="text-7xl uppercase font-semibold">EYE-</h1>
          <h1 className="text-7xl uppercase font-semibold">OPENING</h1>
        </div>
        <svg
          width="72"
          height="30"
      ...
      <div className='w-1/2 p-20 font-["FounderGrotesk"] '>
        ...
        <div className=" dets font-[NueueMontreal] mt-10">
          <span className="block text-3xl"> Social links</span>
          <a
            className="block text-xl font-light"
            href="https://github.com/attiqrehman-ar"
          >
            Github
          </a>
          ...
          <a
            className="block text-xl font-light"
            href="https://www.linkedin.com/in/attiq-rehman-/"
          >
            Linkedin
          </a>
        </div>
        <div className="email text-xl font-light mt-10">
          <span className="block text-3xl">Email:</span>
          <a className="block" href="mailto:attiqrehman130@gmail.com">
            attiqrehman130@gmail.com
          </a>
        </div>
        <div className="email text-xl font-light mt-10">
          <span className="block text-2xl">Book an Appointment:</span>
          <a className="block" href="https://topmate.io/attiq">
            Cick here!!!
          </a>
        </div>
      </div>
